...
- **Brand**: "**Nhimbe**" is capitalized (and "Nhimbe Admin" for the admin app). This reverses the former lowercase-always rule (2026-07-19); some public-app strings may still carry the old lowercase form pending a sweep.
